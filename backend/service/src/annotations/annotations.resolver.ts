...
export class AnnotationsResolver {
  ...
  @Mutation(() => Annotation)
  updateAnnotation(@Args('updateAnnotationInput') updateAnnotationInput: UpdateAnnotationInput) {
    return this.annotationsService.update(updateAnnotationInput.id, updateAnnotationInput);
  }
